    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Lotess", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Lotess_Eventos_EventoId",
                        column: x => x.EventoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RedesSociaias", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RedesSociaias_Eventos_EventoId",
                        column: x => x.EventoId,
                        principalTable: "Eventos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RedesSociaias_Palestrantes_PalestranteId",
                        column: x => x.PalestranteId,
                        principalTable: "Palestrantes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RedesSociaias_EventoId",
                table: "RedesSociaias",
                column: "EventoId");

            migrationBuilder.CreateIndex(
                name: "IX_RedesSociaias_PalestranteId",
                table: "RedesSociaias",
                column: "PalestranteId");
        }
